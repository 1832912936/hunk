...
<div class="col-md-6">
    <table class="table table-hover" id="emr_table" style="border-collapse: collapse;">
        ...
        <tr>
            ...
            <td class="sfzh"><b>身份证号码：</b></td>
        </tr>
        <tr>
            <td class="xb"><b>性别：</b></td>
            <td class="gjdz"><b>籍贯：</b></td>
        </tr>

        <tr>
            <td class="nly"><b>年龄：</b></td>
            <td class="gzdw"><b>单位：</b></td>
        </tr>
        <tr>
            <td class="hf"><b>婚否：</b></td>
            <td class="gjdz"><b>住址：</b></td>
        </tr>
        <tr>
            <td class="minzu"><b>名族：</b></td>
            <td class="ryrq"><b>入院日期：</b></td>
        </tr>
        <tr>
            <td class="zy"></td>
            <td class="cjrq"></td>
...
<script type="text/javascript">
    ...
    function find_stuc_text(result){
        ...
        $.each(Emr_bl_list,function (index, item) {
            ...
            var biaotou =  $("<td class='lead'></d>").append(item.stuctname)
            var neirong = $("<td></td>").append(item.stuctext)
            $("<tr></tr>").append(biaotou)
            .append(neirong)
        ...
        $.each(hzxx,function (index,item) {
         ...
         //   var zs =  $("<td></td>").append(item.zs1)
          ...
          //  var ybqk1 = $("<td></td>").append(item.ybqk1)
            ...
            if (item.xb1 !=null){
                ...
                var xb_nr = item.xb1.substring(xb_jq + 1, item.xb1.length);// 获取到：后面所有的内容
         ...
         //  var jzsz1 =  $("<td></td>").append(item.jzsz1)
            if (item.jzsz1 !=null){
                ...
                var jzsz_nr = item.jzsz1.substring(jzsz_jq + 1, item.jzsz1.length);// 获取到：后面所有的内容
           ...
           //var xz1 =  $("<td></td>").append(item.xz1)
            if (item.xz1 !=null){
                ...
                var xz_nr = item.xz1.substring(xz_jq + 1, item.xz1.length);// 获取到：后面所有的内容
            ...
            if (item.fb1 !=null){
                ...
                var fb_nr = item.fb1.substring(fb_jq + 1, item.fb1.length);// 获取到：后面所有的内容
           ...
           // var zc1 =  $("<td></td>").append(item.zc1)
            if (item.zc1 !=null){
                ...
                var zc_nr = item.zc1.substring(zc_jq + 1, item.zc1.length);// 获取到：后面所有的内容
           ...
           // var sjxt1 =  $("<td></td>").append(item.sjxt1)
            if (item.sjxt1 !=null){
                ...
                var sjxt_nr = item.sjxt1.substring(sjxt_jq + 1, item.sjxt1.length);// 获取到：后面所有的内容
